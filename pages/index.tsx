        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 py-8 px-4">
          {posts.map((post) => (
            <Link key={post._id} href={`/post/${post.slug.current}`}>
              <div className="group rounded-md overflow-hidden bg-[#1a1a1a] border border-gray-700 hover:border-[#00FFC3] shadow-md transition duration-300 hover:shadow-[0_0_12px_#00FFCB55] flex flex-col justify-between cursor-pointer">
                {/* IMAGE */}
                <div className="w-full h-[220px] overflow-hidden image-container">
                  <Image
                    ...
                    className="w-full h-full object-cover brightness-75 transition-transform duration-300 image-zoom"
                  />
                </div>
